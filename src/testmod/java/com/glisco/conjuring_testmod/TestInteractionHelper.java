...
public class TestInteractionHelper {
    ...
    private void initPlayer() {
        ...
        this.player = new ServerPlayerEntity(this.ctx.getWorld().getServer(), this.ctx.getWorld(), new GameProfile(UUID.randomUUID()
                , "test-mock-player"), MinecraftClient.getInstance().getProfileKeys().getPublicKey()) {
